...
language-neutral skeleton; the words live in corpora, one per edition,
...
fixture file that exercises it ([ADR 0015](docs/adr/0015-engine-interface-owned-by-colregs.md)).
