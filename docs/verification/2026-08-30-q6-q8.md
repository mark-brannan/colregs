...
**Verdict: REFUTED.** Of 90 paths, **18 are the dangerous case** (15 in the first pass; see the 2026-09-05 correction) — identical
...
absences. Roughly 68 of 90 are citation-compatible.
...
- The deposited 1972 treaty text (UNTS Vol. 1050, I-15824, Rules
  ...
  items touch Rules 23(c)/(d), 24, 27, 29(a)(iii) and 30 — the <12 m
...
- The rows are now classified as CFR-side divergences (`DIFFERENT`), which
  raises the dangerous-case count from 15 to 18 and leaves the verdict
  unchanged.
