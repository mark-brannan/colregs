...
| `EncounterEvaluation` field set (§4) — `categories` and `provenance` added 2026-09-16, as `DisplayEvaluation` carries them: colregs-engine 0.1.5 built them and ADR 0014's schema transcribes the engine | ✎ | building it; Q-35, Q-36, Q-43 in colregs |
